            ...
            <div className="rounded-3xl border border-black/10 dark:border-white/10 bg-white/50 dark:bg-white/5 p-6 shadow-2xl backdrop-blur-xl lg:col-span-1">
              ...
              <div className="mt-6 space-y-3">
                ...
                <button
                  ...
                  onClick={addCompany}
                  className="mt-2 w-full rounded-2xl bg-black dark:bg-white py-3 font-semibold text-white dark:text-black disabled:cursor-not-allowed disabled:opacity-60 transition"
                >
                ...
                {createdCredentials && (
                  <div className="rounded-2xl border border-emerald-500/25 bg-emerald-500/10 p-4">
                    ...
                    <div className="mt-3 text-xs text-emerald-700 dark:text-emerald-200/70">
                      Login ID
                    </div>
                    <div className="mt-1 font-mono text-sm text-emerald-900 dark:text-emerald-100">
                    ...
                    <div className="mt-2 text-xs text-emerald-800 dark:text-emerald-200/60">
                    ...
                    <div className="flex min-w-0 items-center gap-3">
                      {c.logoUrl ? (
                        <img
                          src={c.logoUrl}
                          alt={c.name}
                          className="h-9 w-24 rounded border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 object-contain"
                        />
                      ) : (
                        <div className="grid h-9 w-24 place-items-center rounded border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 text-[10px] text-black/60 dark:text-white/60">
                          NO LOGO
                        </div>
                      )}
